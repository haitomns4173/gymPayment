...
<head>
    ...
    <title>Menu - Gym Payment Dashboard</title>
            ...
            <section class="row">
                    ...
                    <div class="card widget-todo">
                        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                            <h4 class="card-title d-flex">
                                <i class="bx bx-check font-medium-5 pl-25 pr-75"></i>Member Update Form
                            </h4>
                        </div>
                        ...
                        if (isset($_GET['member_id'])) {
                            ...
                            $sql = "SELECT * FROM `members_list` WHERE member_id = '$member_id'";
                        ...
                        <div class="card-body px-0 py-1">
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="php/updateMember.php?member_id=<?php echo $member_id ?>" method="post" enctype="multipart/form-data" class="form form-vertical" data-parsley-validate>
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="email-id-vertical" class="form-control" name="member_phone" placeholder="Phone Number" value="<?php echo $member_phone ?>" data-parsley-required />
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Address</label>
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="member_address" placeholder="Address" value="<?php echo $member_address ?>" data-parsley-required />
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Blood Group</label>
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="member_bloodgroup" placeholder="Blood Group" value="<?php echo $member_bloodGroup ?>" data-parsley-required />
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="contact-info-vertical">Height</label>
                                                        <input type="text" id="contact-info-vertical" class="form-control" name="member_height" placeholder="Height in Feet & Inches" value="<?php echo $member_height ?>" data-parsley-required />
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                ...
                <div class="col-12 col-lg-7">
                    <div class="card widget-todo">
                        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                            <h4 class="card-title d-flex">
                                <i class="bx bx-check font-medium-5 pl-25 pr-75"></i>Member Image Update
                            </h4>
                        </div>
                        <div class="card-body px-0 py-1">
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="php/memberImageUpdate.php?member_id=<?php echo $member_id ?>" method="post" enctype="multipart/form-data" class="form form-vertical" data-parsley-validate>
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <img src="php//<?php echo $member_image ?>" alt="member image" class="img-fluid" width="100%" height="100%">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
