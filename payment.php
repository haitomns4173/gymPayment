...
<head>
    ...
    <title>Payment - Gym Payment Dashboard</title>
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="php/addPayment.php" method="post" data-parsley-validate>
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="first-name-column">ID</label>
                                                    <input type="text" id="first-name-column" class="form-control" placeholder="Member ID" name="member_id" data-parsley-required />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="last-name-column">Amount</label>
                                                    <input type="number" id="last-name-column" class="form-control" min="1" placeholder="Amount" name="amount" data-parsley-required />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="last-name-column">Date</label>
                                                    <input type="date" id="last-name-column" class="form-control" placeholder="Phone Number" name="payment_date" data-parsley-required />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
